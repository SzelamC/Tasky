    ...
    <div className="mx-auto my-16 flex max-h-fit max-w-sm flex-col gap-4 text-center">
      ...
      <div className="rounded-md border border-gray-200 p-4 shadow-sm">
        <SimpleInput
          ...
          className="w-full rounded-md border border-gray-200 bg-white p-2 text-xs outline-none focus:border-green-400 focus:ring-2 focus:ring-green-300 focus:ring-opacity-20"
        />
        <SimpleInput
          label="Password"
          placeholder="Enter here..."
