...
function Divide(props: { focusEmail: () => void }) {
  return (
    <div className="flex items-center justify-between">
      <span className="h-0.5 w-1/5 bg-gray-200"></span>
      <a
        href="#"
        className="text-[0.65rem]  font-semibold uppercase leading-4 text-gray-400 hover:underline"
        onClick={props.focusEmail}
      >
        or use your email
      </a>
      <span className="h-0.5 w-1/5 bg-gray-200"></span>
