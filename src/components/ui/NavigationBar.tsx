...
export default function NavigationBar() {
  return (
    <nav className="w-full bg-white p-4 shadow-[0_4px_8px_0] shadow-slate-200">
        ...
        <div className="flex items-center gap-10">
          <ul className="hidden items-center gap-6 text-sm text-gray-600 sm:flex">
            ...
            <li>
              <NavigationLink
                href="/login"
                className="rounded-md bg-green-400 px-4 py-1.5 text-sm font-normal text-black hover:bg-green-500 active:bg-green-600"
              >
                Login
              </NavigationLink>
            </li>
