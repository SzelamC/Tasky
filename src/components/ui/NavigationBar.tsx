...
export default function NavigationBar() {
  return (
    <nav className="bg-white shadow-slate-200 w-full p-4 shadow-[0_4px_8px_0]">
      <div className="mx-auto flex max-w-3xl items-center justify-between md:max-w-7xl">
        <TaskyLogoIcon />
        <div className="flex items-center gap-10">
          <ul className="text-gray-600 hidden items-center gap-6 text-sm sm:flex">
            <li>
              <NavigationLink
                href="#"
            ...
            <li>
              <NavigationLink href="/login">
                <Button size="xs" color="primary" variants="contained">
                  Login
                </Button>
              </NavigationLink>
            </li>
